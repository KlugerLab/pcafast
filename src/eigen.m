...
%EIGEN  Eigendecomposition of a SELF-ADJOINT (and possibly NON-NEGATIVE DEFINITE) matrix
%
%
...
%           variable signifying the input matrix A is non-negative
%           definite.
%           
%
...
%   nnd_flag -- set to true if the matrix is non-negitive definite.
%
